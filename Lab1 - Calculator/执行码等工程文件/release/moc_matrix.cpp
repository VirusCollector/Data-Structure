...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_matrix_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_matrix_t qt_meta_stringdata_matrix = {
    {
        QT_MOC_LITERAL(0, 6),  // "matrix"
        QT_MOC_LITERAL(7, 14),  // "on_run_clicked"
        QT_MOC_LITERAL(22, 0)   // ""
    },
    "matrix",
    "on_run_clicked",
...
const QMetaObject matrix::staticMetaObject = { {
    ...
    qt_meta_stringdata_matrix.offsetsAndSizes,
    qt_meta_data_matrix,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_matrix_t
, QtPrivate::TypeAndForceComplete<matrix, std::true_type>
